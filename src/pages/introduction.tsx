        ...
        <>
            <section id="introduction" className="flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-800 p-8">
                ...
                <ul className="flex gap-4  flex-col font-semibold text-2xl text-gray-800 dark:text-gray-50 ">
                    ...
                    <li>
                        - 📫 How to reach me, you can send to my email <a href="mailto:name@email.com" target="_blank" className="underline">dckydrm1@gmail.com</a> or check my <a href="mailto:name@email.com" target="_blank" className="underline"> LinkedIn </a>
                    </li>
                </ul>
            </section>
        </>
