...
export default function Navbar() {
    ...
    return (
        <>
            ...
            <button
                onClick={() => isShow(!show)}
                className={`fixed m-4 right-0 bottom-0 z-50 bg-gray-800 focus:bg-gray-200  p-4 rounded-full block sm:hidden transition-all duration-300 delay-75 ease-linear`}>
                {show ? (
                    <>
	...
	11.387,0 0.561,10.811 234.191,244.996 0.561,479.174 "/>
                    ...
                    <>
                        <svg width="32px" height="32px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path className="stroke-gray-200 hover:stroke-gray-400 dark:stroke-gray-800 |" d="M4 18L20 18" stroke="#000000" strokeWidth="2" strokeLinecap="round" />
                            <path className="stroke-gray-200 hover:stroke-gray-400 dark:stroke-gray-800 |" d="M4 18L20 18" stroke="#000000" strokeWidth="2" strokeLinecap="round" />
                            <path className="stroke-gray-200 hover:stroke-gray-400 dark:stroke-gray-800" d="M4 12L20 12" strokeWidth="2" strokeLinecap="round" />
                            <path className="stroke-gray-200 hover:stroke-gray-400 dark:stroke-gray-800" d="M4 6L20 6" stroke="#000000" strokeWidth="2" strokeLinecap="round" />
                        </svg>
                    </>
                )
                }
